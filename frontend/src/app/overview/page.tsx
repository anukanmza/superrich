...
export default function OverviewPage() {
  return (
    <div className="p-6 h-full overflow-y-auto">
      <h1 className="text-xl font-bold text-[#89b4fa] mb-6">📌 ภาพรวม (Overview)</h1>
      <div className="bg-[#11151e] border border-[#2a4a6b] rounded-lg p-6 max-w-2xl text-center">
        ...
        <p className="text-[#6c7086]">หน้านี้จะแสดงแดชบอร์ดสรุปยอดขาย กำไร และความเสี่ยงแบบ Real-time</p>
      </div>
    </div>
  );
}
